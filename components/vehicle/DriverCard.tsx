...
export const DriverCard = ({ driver }: { driver: Driver }) => {
  return (
    <View style={styles.containerInfo}>
      ...
      {/* Owner details body */}
      <CardDataRow title={"Name"} value={`${driver.firstName} ${driver.lastName}`} />
      <CardDataRow title={"License Number"} value={driver.licenseId} />
      <View
        style={{
          width: "100%",
      ...
      >
        ...
        >
          <View style={{ flex: 1, marginRight: 2 }}>
            <NeuImage image={driver.licenseImage} cover={true} />
          </View>
          <View style={{ flex: 1 }}>
            <NeuImage image={driver.selfiePicture} cover={true} />
          </View>
        </View>
      </View>
    </View>
